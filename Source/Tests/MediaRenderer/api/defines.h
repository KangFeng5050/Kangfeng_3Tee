...
#if (defined(RT_LINUX) && !defined(RT_ANDROID)) || defined(RT_WIN32) || (defined(RT_MAC) && !defined(RT_IOS))
#ifndef RT_DESKTOP
#define RT_DESKTOP
#endif // RT_DESKTOP
#endif
...
#elif defined (RT_UNIX) || defined(RT_MACOS) || defined(RT_IOS) || defined(RT_LINUX)
  #define RT_OS_SEPARATE '/'
#endif
