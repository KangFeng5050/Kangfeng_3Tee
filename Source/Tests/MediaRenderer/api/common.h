...
struct RoomInfo {
	RoomInfo() : startTime(0), duration(0), bandwidth(0),
		maxAttendee(0), maxAudio(0), maxVideo(0), roomMode(0), enable_voice_activated(false), status(rs_scheduled) {}
...
static uint32 AllSupportedTools() {
    return tee3::avd::annotation_tool_mouse
        | tee3::avd::annotation_tool_line
        | tee3::avd::annotation_tool_rectangle
        | tee3::avd::annotation_tool_ellipse
        | tee3::avd::annotation_tool_polyline
        | tee3::avd::annotation_tool_polygon
        | tee3::avd::annotation_tool_hlight_point
        | tee3::avd::annotation_tool_hlight_texttag
        | tee3::avd::annotation_tool_eraser_line
        | tee3::avd::annotation_tool_eraser_rectangle
        | tee3::avd::annotation_tool_rhomb
        | tee3::avd::annotation_tool_success
        | tee3::avd::annotation_tool_failure
        | tee3::avd::annotation_tool_arrow;
}
